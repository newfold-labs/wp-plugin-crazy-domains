...
<div class="nfd-root nfd-widget nfd-widget-site-preview">
	...
	<div id="iframe-preview-wrap">
		...
		>
			<p class="nfd-font-bold"><?php esc_html_e( 'Site Preview', 'wp-plugin-crazy-domains' ); ?></p>
		</div>
		<div class="iframe-wrap">
			<iframe
				id="iframe-preview"
				title="<?php esc_attr_e( 'Site Preview', 'wp-plugin-crazy-domains' ); ?>"
		...
		>
			...
			">
				...
				<span>
					<?php
						echo $isComingSoon ?
						esc_html__( 'Not Live', 'wp-plugin-crazy-domains' ) :
						esc_html__( 'Live', 'wp-plugin-crazy-domains' );
					?>
				</span>
			</span>
		</div>
	...
	>
		<?php
			echo $isComingSoon ?
			esc_html__( 'Your website is currently displaying a "Coming Soon" page.', 'wp-plugin-crazy-domains' ) :
			esc_html__( 'Your website is live to the world!', 'wp-plugin-crazy-domains' );
		?>
	</p>
	...
	<div class="site-preview-widget-buttons nfd-flex nfd-gap-2 nfd-justify-between nfd-items-center nfd-text-center nfd-mt-4 nfd-mb-4">
		...
		>
			...
			<?php
				$isComingSoon ?
				esc_html_e( 'Preview Site', 'wp-plugin-crazy-domains' ) :
				esc_html_e( 'View Site', 'wp-plugin-crazy-domains' );
			?>
		</a>
		<a 
			class="nfd-button nfd-button--secondary"
		...
		>
			...
			<?php esc_html_e( 'Edit Site', 'wp-plugin-crazy-domains' ); ?>
		</a>
		<?php if ( $isComingSoon ) : ?>
			<a 
			...
			>
				...
				<?php esc_html_e( 'Launch Site', 'wp-plugin-crazy-domains' ); ?>
			</a>
		<?php else : ?>
			<a 
			...
			>
				...
				<?php esc_html_e( 'Enable Coming Soon', 'wp-plugin-crazy-domains' ); ?>
			</a>
		<?php endif; ?>
		</div>
</div>
