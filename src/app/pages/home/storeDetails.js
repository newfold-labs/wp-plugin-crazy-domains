...
const StoreDetails = () => {
	...
	const titleText =
		siteKind === 'store'
			? __( 'Congrats, your store is live!', 'wp-plugin-crazy-domains' )
			: __( 'Congrats, your website is live!', 'wp-plugin-crazy-domains' );
	const detailsButtonText = hasStoreInfo
		? __( 'Store Details', 'wp-plugin-crazy-domains' )
		: __( 'Add Store Details', 'wp-plugin-crazy-domains' );
