...
const AutomaticUpdatesAll = ({ setError, notify }) => {
	...
	const getAllNoticeTitle = () => {
		return autoUpdatesAll
			? __('Enabled All auto-updates', 'wp-plugin-crazy-domains')
			: __('Disabled All auto-updates', 'wp-plugin-crazy-domains');
	};
	const getAllNoticeText = () => {
		return autoUpdatesAll
			? __('Everything will automatically update.', 'wp-plugin-crazy-domains')
	...
	return (
		<ToggleField
			...
			label={__('Manage All Updates', 'wp-plugin-crazy-domains')}
...
const AutomaticUpdatesMajorCore = ({ setError, notify }) => {
	...
	const getCoreNoticeTitle = () => {
		return autoUpdatesMajorCore
			? __('Enabled Core auto-updates', 'wp-plugin-crazy-domains')
			: __('Disabled Core auto-updates', 'wp-plugin-crazy-domains');
	};
	...
	const toggleAutoUpdatesMajorCore = () => {
		crazydomainsSettingsApiFetch({ autoUpdatesMajorCore: !autoUpdatesMajorCore }, setError, (response) => {
...
const AutomaticUpdatesPlugins = ({ setError, notify }) => {
	...
	const getPluginsNoticeTitle = () => {
		return autoUpdatesPlugins
			? __('Enabled Plugins auto-update', 'wp-plugin-crazy-domains')
			: __('Disabled Plugins auto-update', 'wp-plugin-crazy-domains');
	};
	...
	const toggleAutoUpdatesPlugins = () => {
		crazydomainsSettingsApiFetch({ autoUpdatesPlugins: !autoUpdatesPlugins }, setError, (response) => {
...
const AutomaticUpdatesThemes = ({ setError, notify }) => {
	...
	const getThemesNoticeTitle = () => {
		return autoUpdatesThemes
			? __('Enabled Themes auto-update', 'wp-plugin-crazy-domains')
			: __('Disabled Themes auto-update', 'wp-plugin-crazy-domains');
	};
	...
	const toggleAutoUpdatesThemes = () => {
		crazydomainsSettingsApiFetch({ autoUpdatesThemes: !autoUpdatesThemes }, setError, (response) => {
...
const AutomaticUpdates = () => {
	...
	return (
		<Container.SettingsField
			title={__('Automatic Updates', 'wp-plugin-crazy-domains')}
			description={__('Keeping automatic updates on ensures timely security fixes and the latest features.', 'wp-plugin-crazy-domains')}
		>
