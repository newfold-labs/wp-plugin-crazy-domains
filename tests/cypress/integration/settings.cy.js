...
describe('Settings Page', function () {
	...
	it('Has Coming Soon', () => {
		cy
			.get('.wppcd-app-settings-coming-soon')
			.scrollIntoView()
			.should('be.visible');
	});
	...
	it('Has Content Settings', () => {
		cy
			.get('.wppcd-app-settings-content')
			.scrollIntoView()
			.should('be.visible');
	});
	...
	it('Has Comments Settings', () => {
		cy
			.get('.wppcd-app-settings-comments')
			.scrollIntoView()
			.should('be.visible');
	});
	...
	it('Comment Settings Work', () => {
		...
		cy.get('[data-id="comments-per-page-select"]')
			...
			.click(); // 10
		cy.wait(100);
		cy.get('.wppcd-app-settings-comments')
